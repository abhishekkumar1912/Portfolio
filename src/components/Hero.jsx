...
const Hero = () => {
  ...
  const onButtonClick = () => {                    
    fetch(Abhishek_Resume).then((response) => {                                      // using Java Script method to get PDF file
      ...
      <div className={`${styles.paddingX} absolute z-10 inset-0 top-[100px] max-w-7xl mx-auto flex flex-row items-start gap-5 h-fit`} >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm{" "}
            <span className="animate-text text-[#915eff] bg-clip-text font-black"> Abhishek </span>
          </h1>
